...
![AgentSkills Banner](https://img.shields.io/badge/AgentSkills-v3.0_Enterprise-00C781?style=for-the-badge&logo=probot&logoColor=white)
<br/>
...
mindmap
  root((AgentSkills v3.0))
    ...
    Xuất Cấu Hình & Tương Tác
      ...
      Image-to-Binary Matrix 01 Generator
    Hạ Tầng Đa Nền Tảng
...
flowchart TD
    ...
    subgraph Storage Layer ["💾 Tầng Lưu Trữ & Bảo Mật / Storage & Security"]
        ...
        AUTH["JWT Security & Non-Root App User"]
    end

    subgraph Application & Presentation ["💻 Tầng Ứng Dụng & Giao Diện / Application & UI"]
        FASTAPI["FastAPI Backend Server (Port 8899)"]
        VERCEL["Vercel CDN Frontend (React + Vite)"]
        MATRIX_CANVAS["Canvas Image-to-Binary Matrix Engine"]
        PLAYGROUND["Interactive Prompt Simulator"]
    end
